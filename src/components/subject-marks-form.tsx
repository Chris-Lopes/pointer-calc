...
const SUBJECTS = {
  Computer: [
    ...
    { name: "One Course from CC", credits: 1, maxMarks: 50 },
  ...
  AIDS: [
    ...
    { name: "Analysis of Algorithms", credits: 0, maxMarks: 150 },
    { name: "Database Management System", credits: 0, maxMarks: 150 },
    { name: "Data Analytics and Visualization", credits: 0, maxMarks: 150 },
    { name: "Emerging Technology and Law", credits: 0, maxMarks: 100 },
    { name: "Open Elective-3", credits: 0, maxMarks: 100 },
    { name: "Web Programming", credits: 0, maxMarks: 100 },
    { name: "Modern Indian Language", credits: 0, maxMarks: 100 },
    { name: "Technology Entrepreneurship", credits: 0, maxMarks: 100 },
    {
      name: "Technology Innovation for Sustainable Development",
      credits: 0,
      maxMarks: 100,
    },
    { name: "One Course from CC", credits: 0, maxMarks: 50 },
    { name: "Indian Knowledge System", credits: 0, maxMarks: 100 },
    { name: "Human Health Systems", credits: 0, maxMarks: 50 },
    { name: "Creative Coding in Python", credits: 0, maxMarks: 100 },
  ],
  ECS: [
    { name: "Mathematics and Numerical Methods", credits: 0, maxMarks: 150 },
    { name: "Analog Electronics", credits: 0, maxMarks: 150 },
    {
      name: "Discrete Structures and Automata Theory",
      credits: 0,
      maxMarks: 150,
    },
    { name: "Embedded Systems", credits: 0, maxMarks: 150 },
    { name: "Emerging Technology and Law", credits: 0, maxMarks: 100 },
    { name: "Operating Systems", credits: 0, maxMarks: 100 },
    { name: "Data Structures", credits: 0, maxMarks: 100 },
    { name: "Modern Indian Language", credits: 0, maxMarks: 100 },
    { name: "Technology Entrepreneurship", credits: 0, maxMarks: 100 },
    {
      name: "Technology Innovation for Sustainable Development",
    ...
    { name: "One Course from CC", credits: 0, maxMarks: 50 },
    { name: "Electromagnetic Theory", credits: 0, maxMarks: 100 },
    { name: "Creative Coding in Python", credits: 0, maxMarks: 100 },
  ],
  Mechanical: [
    { name: "Fundamentals of Thermodynamics", credits: 0, maxMarks: 150 },
    { name: "Mechanics of Solids", credits: 0, maxMarks: 150 },
    { name: "Materials Science and Engineering", credits: 0, maxMarks: 150 },
    { name: "Materials and Material Testing", credits: 0, maxMarks: 150 },
    { name: "Emerging Technology and Law", credits: 0, maxMarks: 100 },
    { name: "Open Elective-3", credits: 0, maxMarks: 100 },
    { name: "Computer Aided Machine Drawing", credits: 0, maxMarks: 100 },
    { name: "Modern Indian Language", credits: 0, maxMarks: 100 },
    { name: "Technology Entrepreneurship", credits: 0, maxMarks: 100 },
    {
      name: "Technology Innovation for Sustainable Development",
