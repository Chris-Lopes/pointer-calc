...
const SUBJECTS_SEM5: Record<string, Subject[]> = {
  ...
  AIDS: [
    ...
    {
      name: "Data Analytics and Visualization Lab",
      credits: 1,
      maxMarks: 50,
      placeholder: false,
    },
  ...
  ECS: [
    {
      name: "Embedded Systems and RTOS",
      credits: 3,
      maxMarks: 100,
      placeholder: true,
    },
    ...
    {
      name: "Department Level Optional Course-II",
      credits: 3,
      maxMarks: 100,
      placeholder: true,
    },
    ...
    {
      name: "Data Warehousing and Mining Lab",
      credits: 1,
      maxMarks: 50,
      placeholder: false,
    },
  ...
  Mechanical: [
    ...
    {
      name: "Measurements and Automation Lab",
      credits: 2,
      maxMarks: 50,
      placeholder: false,
    },
    {
      name: "Mini Project – 2 B",
      credits: 2,
      maxMarks: 50,
      placeholder: true,
    },
