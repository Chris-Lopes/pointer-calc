...
const SUBJECTS = {
  ...
  ECS: [
    ...
    {
      courseCode: "25BSC11EC02",
      name: "Fundamentals of Electromagnetics and Semiconductor Devices",
      credits: 3,
      maxMarks: 150,
      placeholder: true,
    },
...
function matchesCourseCode(subjectCode: string, cieCode: string): boolean {
  ...
  // Check if it's IKS course (starts with 25IKS)
  if (subjectCode.startsWith("25IKS")) {
    return cieCode.startsWith("25IKS");
  }

  // Check if it's VSE course (starts with 25VSE)
  if (subjectCode.startsWith("25VSE")) {
    return cieCode.startsWith("25VSE");
  }
